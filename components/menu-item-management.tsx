...
import { UpdateMenuItemDialog } from './update-menu-item-dialog';
...
export function MenuItemManagement() {
  ...
  const updateMenuItems = (updatedMenuItem: MenuItem) => {
    setMenuItems(
      menuItems.map((menuItem) =>
        menuItem.id === updatedMenuItem.id ? { ...menuItem, ...updatedMenuItem } : menuItem,
      ),
    );
  };
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      <UpdateMenuItemDialog menuItem={item} onMenuitemUpdated={updateMenuItems} />
                      <Button
                        variant="outline"
                        size="icon"
